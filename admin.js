...
var HS_T={
 ...
 f_sbY:{ar:"الموضع الرأسي (px)",en:"Vertical position (px)",de:"Vertikale Position (px)"}, f_sbGlow:{ar:"وميض ذهبي متحرك حول شريط البحث",en:"Moving golden shine around the search bar",de:"Wandernder Goldglanz um die Suchleiste"}, g_aiBar:{ar:"شريط البحث الذكي (AI)",en:"AI search bar",de:"KI-Suchleiste"}, f_aiOn:{ar:"إظهار شريط البحث الذكي تحت شريط البحث",en:"Show the AI search bar under the search bar",de:"KI-Suchleiste unter der Suchleiste anzeigen"}, f_aiEx:{ar:"إظهار أمثلة جاهزة تحت الشريط",en:"Show example searches under the bar",de:"Beispielsuchen unter der Leiste anzeigen"}, f_aiGlass:{ar:"شريط ذكي شفاف (زجاجي)",en:"Glass (transparent) AI bar",de:"Transparente (Glas-)KI-Leiste"}, f_aiHint:{ar:"الشريط الذكي يأخذ تلقائياً عرض وارتفاع شريط البحث الرئيسي المضبوطين أعلاه.",en:"The AI bar automatically follows the main bar's width and height set above.",de:"Die KI-Leiste übernimmt automatisch die oben eingestellte Breite und Höhe der Hauptleiste."}, f_sbGlass:{ar:"شريط بحث شفاف (زجاجي) على الكمبيوتر",en:"Transparent (glass) search bar on desktop",de:"Transparente (Glas-)Suchleiste am Computer"}, f_sbGlassM:{ar:"شريط بحث شفاف (زجاجي) على الهاتف",en:"Transparent (glass) search bar on phones",de:"Transparente (Glas-)Suchleiste am Handy"}, f_sbGlassHint:{ar:"يظهر الشريط زجاجياً فوق صورة الخلفية مع إبقاء الحقول بإطار صلب واضح للقراءة.",en:"The bar turns to glass over the background photo while the fields keep a solid, readable frame.",de:"Die Leiste wird über dem Hintergrundfoto glasig, die Felder behalten einen festen, lesbaren Rahmen."}, f_sbW:{ar:"أقصى عرض (px)",en:"Maximum width (px)",de:"Maximale Breite (px)"}, f_sbH:{ar:"ارتفاع الحقول (px)",en:"Field height (px)",de:"Feldhöhe (px)"},
...
function hsInspHome(){
  ...
  if(sd==="hero_text"){
    ...
    H.push(fGrp(hsT("g_aiBar")), fSwitch(hsT("f_aiOn"),"x:ai_bar_on",true,true), fSwitch(hsT("f_aiEx"),"x:ai_bar_examples",true,true), fSwitch(hsT("f_aiGlass"),"x:ai_bar_glass",false,true), fHint(hsT("f_aiHint")));
